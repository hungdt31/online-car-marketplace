...
<div class="container-fluid px-4 py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
        ...
        <!-- Add New Post Button -->
        <a href="<?= _WEB_ROOT ?>/admin/posts/add" class="btn btn-add">
                            ...
                            <tr class="post-row">
                                ...
                                <td class="text-center align-middle">
                                    <div class="action-buttons">
                                        <a href="<?= _WEB_ROOT ?>/blog/<?= htmlspecialchars($post['id']) ?>" target="_blank" class="btn btn-info view-btn">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="<?= _WEB_ROOT ?>/admin/posts/edit/<?= htmlspecialchars($post['id']) ?>" class="btn btn-primary edit-btn">
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5">
                                <div class="empty-state">
                                    ...
                                    <a href="<?= _WEB_ROOT ?>/admin/posts/add" class="btn btn-primary">
