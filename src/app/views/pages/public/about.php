...
<div class="container-fluid py-5" style="margin-top: 30px;">
    ...
    <div class="text-center mb-5">
        <p class="lead text-muted mb-4">Pioneering the future of transportation with innovative electric vehicle solutions</p>
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <p class="mb-4">Since our founding in 2018, ElectriRide has been at the forefront of the electric vehicle revolution.
                    We combine cutting-edge technology with exceptional customer service to make sustainable transportation
                    accessible to everyone.</p>
                <div class="d-flex justify-content-center gap-3 mb-3">
                    <div class="px-4 py-2 bg-light rounded-3 text-center">
                        <h2 class="fw-bold text-primary mb-0">5000+</h2>
                        <p class="small text-muted mb-0">Happy Customers</p>
                    </div>
                    <div class="px-4 py-2 bg-light rounded-3 text-center">
                        <h2 class="fw-bold text-primary mb-0">25+</h2>
                        <p class="small text-muted mb-0">Cities Served</p>
                    </div>
                    <div class="px-4 py-2 bg-light rounded-3 text-center">
